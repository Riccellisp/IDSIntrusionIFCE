...
excel = pd.ExcelWriter('Kneighbors-Classifier.xlsx', engine='xlsxwriter')
...
for x in range(30):
    ...
    #CLASSIFICAÇÃO USANDO KNEIGHBORS
    ...
    #precision_score(y, y_pred, average=None)
    #precision_score(y, y_pred, average=None, zero_division=1)
    ...
    #recall_score(y, y_pred, average=None)
    #recall_score(y, y_pred, average=None, zero_division=1)
